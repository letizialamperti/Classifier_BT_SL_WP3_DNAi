...
class Classifier(pl.LightningModule):
    def __init__(
        ...
        # L'input ora è SOLO l'embedding del campione
        ...
        self.loss_fn_raw = WeightedCoralLoss(reduction=None) # per loss per campione
    ...
    def training_step(self, batch, batch_idx: int) -> torch.Tensor:
        ...
        output = self(embeddings)  # shape (B, num_classes-1)
