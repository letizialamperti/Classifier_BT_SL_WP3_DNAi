...
#OAR -p gpumodel='A100'
#OAR --stdout binary-classifier-sandybed-log.out
#OAR --stderr binary-classifier-sandybed-err.out
...
PROTECTION_FILE="label/label_binaryprotection_sandybed.csv"
HABITAT_FILE="habitat/label_habitat_sandybed.csv"

echo "Starting sandybed binary classification CV over 5 folds…"
...
echo "All 5 sandybed binary folds done!"
